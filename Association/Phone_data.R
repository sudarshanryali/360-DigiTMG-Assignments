# Prepare rules for the dataset "Phone_data"
...
# Loading the dat
data <- read.csv(file.choose(), colClasses= "factor")
...
arules <- apriori(phone_data, parameter = list(support = 0.002, confidence = 0.75, minlen = 2))
arules
...
arules1 <- apriori(phone_data, parameter = list(support = 0.001, confidence = 0.95, minlen = 2))
arules1
...
arules2 <- apriori(phone_data, parameter = list(support = 0.013, confidence = 0.60, minlen = 3))
arules2
